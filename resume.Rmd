...
- <i class="fas fa-pen-nib"></i> Scripting: Python, R, TypeScript
- <i class="fa fa-database"></i> Data Storage/Retrival: Snowflake, Redshift, DynamoDb, Postgres, s3, Athena
- <i class="fas fa-wrench"></i> Data Engineering: dbt, Glue, s3 
