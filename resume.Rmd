...
Made with the R package </br> [**pagedown**](https://github.com/rstudio/pagedown)  
...
Independent Coursework {data-icon=book data-concise=true #ind_coursework}
--------------------------------------------------------------------------------

```{r}
high_level_print_section(position_data, 'independent_coursework')
```
